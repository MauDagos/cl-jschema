...
(defun expected-message (expected-path expected-keyword &optional msg-arg)
  (format nil "~a : ~?"
          expected-path
...
(cl-jschema-test :number-range-test
  ...
  (let ((json-schema-closed (cl-jschema:parse "{
    ...
    (invalid-value json-schema-opened -1 "$ : Number is less or equal to -1")
...
$ : Number is less or equal to -1")
    ...
    (invalid-value json-schema-opened 100 "$ : Number is greater or equal to 100")
    (invalid-value json-schema-mixed  100 "$ : Number is greater or equal to 100")
    ;; -2 is not allowed in any
    (invalid-value json-schema-closed -2 "$ : Number is less than -1")
    (invalid-value json-schema-opened -2 "$ : Number is less or equal to -1")
...
$ : Number is less or equal to -1")
    ...
    (invalid-value json-schema-closed 101 "$ : Number is greater than 100")
    (invalid-value json-schema-opened 101 "$ : Number is greater or equal to 100")
    (invalid-value json-schema-mixed  101 "$ : Number is greater or equal to 100")))
...
(cl-jschema-test :object-property-names-test
  (let ((json-schema
    ...
    (invalid-json json-schema "{\"001 invalid\": \"value\"}"
                  "$.001 invalid : String does not match regex ^[A-Za-z_][A-Za-z0-9_]*$")))
